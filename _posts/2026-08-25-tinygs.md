...
<div class="alert alert-warning" role="alert" markdown="span">
  **Experimental — testers wanted!** Still in active development; please [open an issue](https://gitlab.com/librecube/lib/python-tinygs) if you find a bug.
</div>
...
[TinyGS-SDR](https://gitlab.com/librecube/lib/python-tinygs) is a UNOFFICIAL REIMPLEMENTATION of the ESP32 TinyGS firmware source code
...
The [tinygs](https://pypi.org/project/tinygs/) package pulls in the [softlora](https://pypi.org/project/softlora/) dependency, a complete Python implementation of the LoRa physical layer (PHY) decoder ([source](https://gitlab.com/librecube/lib/python-softlora)).
